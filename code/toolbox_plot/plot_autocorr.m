function varargout = plot_autocorr(y,numLags,numMA,numSTD)
% modification by mc
...
%  Plot the sample ACF:
   ...
   set(lineHandles(1),'MarkerSize',7)
   grid('on')
...
%  null hypothesis is assumed to hold. 
   ...
   plot([numMA+0.5 numMA+0.5; numLags numLags],[bounds([1 1]) bounds([2 2])],'--b','linewidth',2);
